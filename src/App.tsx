...
function App() {
  ...
  return (
    <div>
      <DashboardVersion />
      <Routes>
          <Route path="/" element={<ProtocolDashboard protocolJSON={protocolsToQuery} getData={() => getDeployments()} subgraphEndpoints={subgraphEndpoints} decentralizedDeployments={decentralizedDeployments} />} />
      </Routes>
    </div>
  );
}
